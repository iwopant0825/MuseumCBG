      ...
      <main className="heritage-content">
        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            {[
              { title: "소수서원 (경북 영주)", text: "1543년 한국에서 가장 먼저 설립된 서원으로, 고려 말 성리학을 도입한 안향을 주 제향 인물로 모십니다. 서원 제도의 모범이 되었습니다." },
              { title: "남계서원 (경남 함양)", text: "1552년에 건립된 한국에서 두 번째 서원으로, 정여창을 주 제향 인물로 모시며 한국 서원 건축의 정형적인 배치 방식을 처음으로 구현했습니다." },
              { title: "옥산서원 (경북 경주)", text: "1572년에 세워졌으며 이언적을 주 제향 인물로 모십니다. 출판과 장서의 중심 기구로서 서원의 역할을 정립하고, 누마루를 도입하여 회합 및 유식 기능을 수행했습니다." },
              { title: "도산서원 (경북 안동)", text: "이황(퇴계)을 기리는 한국 대표 서원으로, 학문과 학파의 중심 기구로 발전하는 과정을 잘 보여주며, 탁월한 자연경관과 함께 강당이 비대칭으로 구성된 것이 특징입니다." },
              { title: "필암서원 (전남 장성)", text: "호남 지역의 대표적인 서원으로, 김인후를 제향하며 교육과 제향의 기능을 충실히 수행했습니다." },
              { title: "도동서원 (대구 달성)", text: "김굉필을 제향하는 서원으로, 독특한 건축 양식과 아름다운 자연 경관이 조화를 이룹니다." },
              { title: "병산서원 (경북 안동)", text: "류성룡을 기리는 서원으로, 만대루의 웅장함과 자연과의 조화가 뛰어납니다." },
              { title: "무성서원 (전북 정읍)", text: "최치원과 신잠을 기리는 서원으로, 호남 지역 성리학의 중심지였습니다." },
              { title: "돈암서원 (충남 논산)", text: "성리학의 실천 이론인 예학을 한국적으로 완성한 거점으로 평가받으며, 응도당은 정침이론을 한국 건축 언어로 재해석한 뛰어난 건물입니다." },
            ].map((feature, index) => (
