    ...
    <div className="heritage-page">
      ...
      <main className="heritage-content">
        <section className="description-section">
          <h2>개요</h2>
          <p>
            남한산성은 경기도 광주시에 위치한 조선시대의 산성으로, 수도 한양을 지키던 중요한 방어 시설입니다. 신라 문무왕 13년(673년)에 한산주에 쌓은 주장성(晝長城)의 옛 터를 활용하여 조선 인조 4년(1626년)에 대대적으로 구축되었으며, 이후에도 지속적인 증축과 보수를 거쳐 현재의 모습을 갖추게 되었습니다. 병자호란(1636) 당시 조선 인조가 피난하여 항전한 역사적 장소로, 2014년 유네스코 세계문화유산에 등재되었습니다.
          </p>
        </section>
        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            {[
              { title: "성곽 및 방어 시설", text: "험준한 산세를 활용하여 방어력을 극대화한 둘레 약 12km에 달하는 거대한 산성입니다. 동·서·남문루와 같은 4대문, 장대(將臺, 지휘소), 돈대(墩臺, 포대), 옹성(甕城, 성벽의 일부를 돌출시켜 적을 입체적으로 공격하는 시설), 암문(暗門, 비밀 통로) 등이 있습니다. 특히 수어장대(서장대)는 인조 때 단층으로 건립된 후 영조 때 2층으로 중건된 중요한 지휘소입니다." },
              { title: "행궁", text: "전쟁이나 비상시 임금이 한양도성에서 나와 머무르던 임시 궁궐로, 종묘에 있는 선조의 신주(神主)를 옮길 수 있는 좌전까지 갖추어 조선의 임시 수도 역할을 수행했습니다." },
              { title: "기타 시설", text: "우물, 관아, 군사 훈련 시설, 사찰(망월사, 옥정사 등), 현절사, 침괘정, 지수당, 연무관 등 다양한 군사·민간·종교 시설들이 성곽 내에 자리하고 있습니다." },
            ].map((feature, index) => (
